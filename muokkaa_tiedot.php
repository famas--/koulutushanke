...
$sql = mysql_query ("SELECT * FROM koulutus WHERE koulutusid =$id");
	while($tieto = mysql_fetch_array ($sql)){
		...
		echo "<td>Alkaa</td><td><input type=text name=aloitusaika value=" . $tieto['aloitusaika'] . "></td></tr>";
		echo "<td>Loppuu</td><td><input type=text name=lopetusaika value=" . $tieto['lopetusaika'] . "></td></tr>"; 
		echo "<td>Ilmoittautuminen paattyy</td><td><input type=text name=ilmoittautuminen value=" . $tieto['ilmoittautuminen'] . "></td></tr>";
